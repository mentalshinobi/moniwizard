...
# Конфигурация
CONFIG = {
    "user_token": "OTc1NjM4NDM5MDkxMzg0MzQw.GfGI7M.dCa_W9SmqmiW4PX_tlKzall-UI5jSADQ2uVKyY",  # User token для чтения
    "bot_token": "MTQwMDg1MzkxMTgxNTk4MzEyNQ.GoNC3G.IyYdhPSu3riISDj5IauhJJyxtiUAkXp35aNBzk",    # Bot token для отправки
    "source_server_id": "1131000554005467206",  # ID исходного сервера (строка для discum)
    "target_server_id": 1382453417754231028,    # ID целевого сервера (число для discord.py)
    "channel_mapping": {
